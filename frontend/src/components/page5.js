            ...
            <Typography style={{fontWeight:'bold'}}>Precondition:HCL Functional tester tool should be installed in windows machine.</Typography>
                    <ExpansionPanel defaultExpanded = {true}  >
                        ...
                        <ExpansionPanelDetails>
                            ...
                            <Typography>
                                <ul>
                                    <li>Open HCL Functional Tester tool
                                    </li><li>Select the TestWorkBench perspective.
                                    </li><li>Click on File tab, select New, and then select TestWorkBench project.(File-->New-->TestWorkBench Project)
                                    </li><li>Give the project name, click on "Finish", 
                                    </li><li>Select "Web UI Test" and then select "Next".
                                    </li><li>Give a TestName and click on "Finish".
                                    </li><li>Select the Browser e.g Google Chrome , click on "Next" and "Finish".
                                    </li><li>Goto the Application Url and perform some tests and close the Browser.
                                    </li><li>User can see "Test Generation completed" pop-up and click on "Open Test"
                                    </li><li>Open the test script from Test Navigator and click on "Run Test".
                                    </li><li>Now Run the test script from TestWorkBench.
                                    </li><li>Once the test is complete , automatically the Test Results will be opened.</li>
                    ...
                    <ExpansionPanel>
                        <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                            <Typography>Steps to Integrate Jenkins with RFT tool.</Typography>
                        </ExpansionPanelSummary>
                        <ExpansionPanelDetails>
                            <Typography>
                                <ul>
                                    <li>Download the HCL Web UI Tester(HCL Functional Tester WEb UI 9.2.0.1 Jenkins Plugin) and save it.
                                    </li><li>Login to Jenkins tool as admin.
                                    </li><li>Click on "Manage Jenkins" on the LHS.
                                    </li><li>Click on "Manage Plugins".
                                    </li><li>Goto "Advanced" tab, click on "Choose File"  browse the path for HCL Web UI Tester  and then click on "Upload".</li>
                    ...
                    <ExpansionPanel>
                        ...
                        <ExpansionPanelDetails>
                            <Typography>Precondition:  Agent.jar and Slave-Agent.jnlp is required to make the Slave online.</Typography>
                            <Typography>
                                <ul>
                                    ...
                                    </li><li>Now open a browser and copy paste the below Url to get the “agent.jar” which will go to the “Downloads” folder.
                                    ipaddressofjenkins:portnumber/jnlpJars/agent.jar
                                    ...
                                    </li><li>Under Remote root directory, give the path for the Jenkins e.g
                        ...
                        <ExpansionPanelDetails>
                            ...
                            <Typography>
                                <ul>
                                    ...
                                    </li><li>Under “Exported Statistical Report” in html , give the path for the Result folder These results will be saved in Jenkins workspace.
                                    </li>
                                </ul>
                            </Typography>
                        </ExpansionPanelDetails>
