...
class CreatePL2 extends Component {
    constructor(props) {
        super();
    ...
    render() {
        ...
        const { pipelineArray, selectedPipelineIndex, isCreateDisabled, temp } = this.state;
                        ...
                        <div style={{textAlign: 'center'}}>
                            {pipelineArray.map((serviceArray, sIndex) => {
                                return <div key={sIndex}>
                                    ...
                                    <div style={{marginTop: '5px',marginBottom: '8px'}}><ServiceAssembly serviceArray={serviceArray} sIndex= {sIndex} temp={temp}/></div>
...
export default withStyles(styles) (withRouter(CreatePL2));