    ...
    constructor()
{
    ...
    this.state = {
        steps: [
                    {id: 1,name:'Docker-Container', component: <Page1 />},
                    ...
                    {id: 7,name:'Coming Soon RQM ', component: <Page7 />},
                    {id: 8,name:'Coming Soon RTC ', component: <Page8 />},
                ],
...
getNextStepDetails() {
 ...
 getStepContent(step) {
    ...
    case 7:
        return <div id="screen"><Page7/></div>;
    case 8:
        return <div id="screen"><Page8/></div>;
    default:
        return 'Unknown step';
    }
  }
